...
for (j in 1 : M) {
  ...
  fit1 <- stan(
    file = "mom.stan",  # path to mom.stan
...
save.image("strong_wrong_belief.RData")
...
save.image("strong_wrong_belief_with_outliers.RData")
...
save.image("weak_wrong_belief.RData")
...
save.image("weak_wrong_belief_with_outliers.RData")
...
save.image("correct_belief.RData")
...
save.image("correct_belief_with_outliers.RData")
